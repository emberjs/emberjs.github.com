...
<html lang="en">
  ...
  <body class="examples examples_contacts examples_contacts_node_modules examples_contacts_node_modules_express examples_contacts_node_modules_express_node_modules examples_contacts_node_modules_express_node_modules_connect examples_contacts_node_modules_express_node_modules_connect_node_modules examples_contacts_node_modules_express_node_modules_connect_node_modules_formidable examples_contacts_node_modules_express_node_modules_connect_node_modules_formidable_Readme">
    <div id="header">
      <div id="wrapper">
        <a id="logo" href="/">&nbsp;</a>
        <ul id="nav">
    ...
    <div id="content-wrapper">
      ...
      <div id="content" >
        <h1 id='toc_formidable'>Formidable</h1>
<p><a href="http://travis-ci.org/felixge/node-formidable"><img src="https://secure.travis-ci.org/felixge/node-formidable.png" alt="Build Status"></a></p>
<h2 id='toc_purpose'>Purpose</h2>
<p>A node.js module for parsing form data, especially file uploads.</p>
<h2 id='toc_current-status'>Current status</h2>
...
<h2 id='toc_features'>Features</h2>
<ul>
...
<h3 id='toc_v1-0-0'>v1.0.0</h3>
<ul>
<li>Add support for multipart boundaries that are quoted strings. (Jeff Craig)</li>
</ul>

<p>This marks the beginning of development on version 2.0 which will include
...
<p><strong>Important:</strong> The old property names of the File class will be removed in a
future release.</p>

<p><a href="https://github.com/felixge/node-formidable/compare/v0.9.10...v0.9.11">See Commits</a></p>
<h3 id='toc_older-releases'>Older releases</h3>
...
<h2 id='toc_installation'>Installation</h2>
...
<div class="highlight  "><div class="ribbon"></div><table class="CodeRay"><tr>
  ...
  <td class="code"><pre>npm install formidable@latest</pre></td>
</tr></table>
</div>
<p>Manually:</p>
<div class="highlight  "><div class="ribbon"></div><table class="CodeRay"><tr>
...
3
  ...
  <td class="code"><pre>git clone git://github.com/felixge/node-formidable.git formidable
vim my.js
# var formidable = require('./formidable');</pre></td>
</tr></table>
</div>
...
24
  ...
  <td class="code"><pre>var formidable = require('formidable'),
    http = require('http'),
    sys = require('sys');
...
</div><h2 id='toc_api'>API</h2><h3 id='toc_formidable-incomingform'>formidable.IncomingForm</h3><h4 id='toc_new-formidable-incomingform'>new formidable.IncomingForm()</h4>
<p>Creates a new incoming form.</p>
<h4 id='toc_incomingform-encoding-utf-8'>incomingForm.encoding = &#39;utf-8&#39;</h4>
<p>The encoding to use for incoming form fields.</p>
<h4 id='toc_incomingform-uploaddir-process-env-tmp-tmp-process-cwd'>incomingForm.uploadDir = process.env.TMP || &#39;/tmp&#39; || process.cwd()</h4>
...
<h4 id='toc_incomingform-keepextensions-false'>incomingForm.keepExtensions = false</h4>
...
<h4 id='toc_incomingform-type'>incomingForm.type</h4>
<p>Either &#39;multipart&#39; or &#39;urlencoded&#39; depending on the incoming request.</p>
<h4 id='toc_incomingform-maxfieldssize-2-1024-1024'>incomingForm.maxFieldsSize = 2 * 1024 * 1024</h4>
...
size is 2MB.</p>
<h4 id='toc_incomingform-bytesreceived'>incomingForm.bytesReceived</h4>
<p>The amount of bytes received for this form so far.</p>
<h4 id='toc_incomingform-bytesexpected'>incomingForm.bytesExpected</h4>
<p>The expected number of bytes in this form.</p>
<h4 id='toc_incomingform-parse-request-cb'>incomingForm.parse(request, [cb])</h4>
...
3
  ...
  <td class="code"><pre>incomingForm.parse(req, function(err, fields, files) {
  // ...
});</pre></td>
</tr></table>
</div><h4 id='toc_incomingform-onpart-part'>incomingForm.onPart(part)</h4>
...
5
  ...
  <td class="code"><pre>incomingForm.onPart = function(part) {
...
<h4 id='toc_event-aborted'>Event: &#39;aborted&#39;</h4>
...
<h4 id='toc_event-end'>Event: &#39;end&#39; ()</h4>
...
<h3 id='toc_formidable-file'>formidable.File</h3><h4 id='toc_file-size-0'>file.size = 0</h4>
...
<h4 id='toc_file-path-null'>file.path = null</h4>
...
<h4 id='toc_file-name-null'>file.name = null</h4>
<p>The name this file had according to the uploading client.</p>
<h4 id='toc_file-type-null'>file.type = null</h4>
<p>The mime type of this file, according to the uploading client.</p>
<h4 id='toc_file-lastmodifieddate-null'>file.lastModifiedDate = null</h4>
